...
export class UDFCompatibleDatafeedBase {
    constructor(datafeedURL, streamingURL, // Add streaming URL parameter
    quotesProvider, requester, updateFrequency = 10 * 1000, limitedServerResponse) {
    ...
    unsubscribeBars(listenerGuid) {
        var _a;
        const symbolInfoPromise = (_a = this._symbolsStorage) === null || _a === void 0 ? void 0 : _a.resolveSymbol(listenerGuid);
        symbolInfoPromise === null || symbolInfoPromise === void 0 ? void 0 : symbolInfoPromise.then((symbolInfo) => {
            if (symbolInfo.data_status !== 'streaming') {
